...
import org.quadrifolium.workshop.client.util.GrammarListBox;
import org.quadrifolium.workshop.client.util.LinguisticTreeCellButton;
import org.quadrifolium.workshop.client.util.LinguisticTreeModel;
...
public class QuadrifoliumLemmasView extends QuadrifoliumComponentBaseLayoutDisplay implements QuadrifoliumLemmasPresenter.Display, IQuadrifoliumComponentBaseDisplayModel, HasClickHandlers
{
	...
	{
		List<LemmaWithInflections> aInitialList = new ArrayList<LemmaWithInflections>() ;
