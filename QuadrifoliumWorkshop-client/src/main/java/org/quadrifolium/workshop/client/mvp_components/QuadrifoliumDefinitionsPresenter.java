...
import org.quadrifolium.workshop.client.event.GoToWorkshopDefinitionEvent;
import org.quadrifolium.workshop.client.event.GoToWorkshopDefinitionEventHandler;
...
import org.quadrifolium.workshop.shared.rpc4ontology.GetDefinitionsTriplesAction;
import org.quadrifolium.workshop.shared.rpc4ontology.GetDefinitionsTriplesResult;
import org.quadrifolium.workshop.shared.rpc4ontology.SaveDefinitionAction;
import org.quadrifolium.workshop.shared.rpc4ontology.SaveDefinitionResult;
...
{	
	...
	{
		public void   feedDefinitionsTable(final List<TripleWithLabel> aTriples, final INTERFACETYPE iInterfaceType) ;

		public void   updateView(final List<TripleWithLabel> aTriples, final INTERFACETYPE iInterfaceType) ;

		public void   initializeLanguagesList(final List<LanguageTag> _LanguageTags) ;
	...
	private List<TripleWithLabel> _aDefinitionsTriples ;
	...
	protected void saveEditedElement()
	{
	 ...
	 {
		 List<ButtonBase> aButtons = display.getButtonsArray() ;
