package org.quadrifolium.workshop.client.cytoscape;
...
public class CytoscapePanel extends SimplePanel 
{
	...
	protected void addNextLevel(final LdvModelTree stemma, final QuadrifoliumNode referenceNode) throws NullPointerException
	{
		...
		QuadrifoliumNode sonNode = (QuadrifoliumNode) stemma.getAnchorNode().getSonNodeFromId(referenceNode.getNodeID(), false) ;
		...
		while (null != sonNode)
		{
			...
			// Get next son
			//
			sonNode = (QuadrifoliumNode) sonNode.getFirstBrother() ;
		}
	}
