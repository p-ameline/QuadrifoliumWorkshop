...
import org.quadrifolium.workshop.client.event.GoToWorkshopSemanticEvent;
import org.quadrifolium.workshop.client.event.GoToWorkshopSemanticEventHandler;
import org.quadrifolium.workshop.client.event.WorkshopConceptChangedEvent;
import org.quadrifolium.workshop.client.event.WorkshopConceptChangedEventHandler;
...
import org.quadrifolium.workshop.shared.rpc4ontology.GetSemanticTriplesAction;
import org.quadrifolium.workshop.shared.rpc4ontology.GetSemanticTriplesResult;
...
{	
    ...
    {			
        public void feedLeftSemanticTable(final List<TripleWithLabel> aTriples) ;
        public void feedRightSemanticTable(final List<TripleWithLabel> aTriples) ;
    }
    ...
    public class GetSemanticTriplesForConceptCallback implements AsyncCallback<GetSemanticTriplesResult>
    {
        ...
        {
            List<TripleWithLabel> aObjectTriples = value.getObjectArray() ;
            display.feedLeftSemanticTable(aObjectTriples) ;

            List<TripleWithLabel> aSubjectTriples = value.getSubjectArray() ;
