...
import org.quadrifolium.workshop.client.event.GoToWorkshopLemmaEvent;
import org.quadrifolium.workshop.client.event.GoToWorkshopLemmaEventHandler;
import org.quadrifolium.workshop.client.event.WorkshopConceptSynonymsLoadedEvent;
...
import org.quadrifolium.workshop.shared.ontology.OntologyLexicon;
import org.quadrifolium.workshop.shared.rpc4ontology.GetFullSynonymsForConceptAction;
import org.quadrifolium.workshop.shared.rpc4ontology.GetFullSynonymsForConceptResult;
import org.quadrifolium.workshop.shared.rpc4ontology.SaveLemmaAction;
import org.quadrifolium.workshop.shared.rpc4ontology.SaveLemmaResult;
...
{	
	...
	{			
		public void                  feedLinguisticTree(final List<LemmaWithInflections> aSynonyms, final INTERFACETYPE iInterfaceType) ;
		public void                  feedLinguisticTreeForOthers(final List<LemmaWithInflections> aSynonyms, final INTERFACETYPE iInterfaceType) ;
		...
		public void                  initializeLanguagesList(final List<LanguageTag> aLanguages) ;
	...
	protected List<LemmaWithInflections> _aSynonyms = new ArrayList<LemmaWithInflections>() ;
	...
	protected void saveEditedElement()
	{
		...
		if (null != _editedLemma)
		{
			...
			if ((sText.equals(_editedLemma.getLabel())) && (sGrammar.equals(org.quadrifolium.workshop.shared.ontology.OntologyLexicon.getGrammarString(_editedLemma))))
			{
				closeEditingSession() ;
				return ;
			}
	...
	protected void save2ndEditedElement()
	{
		...
		{
			if ((sText.equals(_2ndEditedLemma.getLabel())) && (sLanguage.equals(_2ndEditedLemma.getLanguage())) && (sGrammar.equals(org.quadrifolium.workshop.shared.ontology.OntologyLexicon.getGrammarString(_2ndEditedLemma))))
			{
				closeSecondEditingSession() ;
				return ;
			}
