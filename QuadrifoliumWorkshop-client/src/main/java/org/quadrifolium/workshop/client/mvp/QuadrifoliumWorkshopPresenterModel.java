...
import org.quadrifolium.workshop.client.event.WorkshopConceptSynonymsLoadedEventHandler;
...
{	
	...
	protected void UpdateSynonymsDependantInformation()
	{
		...
		//
		String sLabel = preferredTerm.getLabel() + " [" + QuadrifoliumFcts.getConceptCode(preferredTerm.getCode()) + "]" ;
		
		eventBus.fireEvent(new CommandDisplayTitleEvent(sLabel)) ;
	}
